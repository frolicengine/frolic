...
process.stdin.on('keypress', (c, k) => {
  switch (k.name) {
    case 'left':
      dispatcher.moveEntity('left', entityCollection);
      break;
    case 'right':
      dispatcher.moveEntity('right', entityCollection);
      break;
    case 'up':
      dispatcher.moveEntity('up', entityCollection);
      break;
    case 'down':
      dispatcher.moveEntity('down', entityCollection);
      break;
    case '1':
  ...
  dispatcher.update(entityCollection);
  dispatcher.moveEntity(null, entityCollection);
});
